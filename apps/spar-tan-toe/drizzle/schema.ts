import { pgTable, foreignKey, bigint, timestamp, uuid, varchar, integer, primaryKey, serial, smallint, pgEnum } from "drizzle-orm/pg-core"
...
export const moves = pgTable("moves", {
	...
	primaryKey({ columns: [table.id, table.gameId], name: "moves_game_id_id_pk"}),
]);
